...
if __name__ == '__main__':
    ...
    if mpath == 'default':  mpath='/home/matsui/bert_nli/output/nli_bert-large-2020-11-07_17-23-12/nli_model_acc0.8831943861332694.state_dict'# mpath = 'output/{}.state_dict'.format(bert_type)
    gpu = bool(gpu)
    hans = bool(hans)
    ...
    #test_data = nli_reader.get_testexamples('/home/matsui/bert_nli/datasets/AllNLI/e_jsnli.csv')
    if hans:
